...
public class DailyCheckerAlarm extends BroadcastReceiver {
    ...
    private void showNotification(Context context) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setContentTitle(context.getString(R.string.daily_check_title))
                .setContentText(context.getString(R.string.daily_check_message))
    ...
    public void setDailyAlarm(Context context, String time) {
        ...
        Intent intent = new Intent(context, DailyCheckerAlarm.class);
